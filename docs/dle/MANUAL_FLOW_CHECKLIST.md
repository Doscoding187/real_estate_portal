...
| Edit rental unit types | Rental inventory/pricing updates safely | Partial | Focused API/DB guardrails passed for rental canonical submit/update, stale sale-field stripping, rental aggregates, public search configurations, and rental lead context. Browser edit-published ownership remains pending. Evidence: `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`. |
