...
| Edit rental unit types | Rental inventory/pricing updates safely | Partial | Focused API/DB guardrails now prove published rental unit edits preserve location, media, highlights, governance, approval, public search/detail output, and monthly-rent aggregates. Browser edit-published ownership remains pending. Evidence: `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`. |
| Edit auction unit types | Auction inventory/pricing updates safely | Partial | Focused API/DB guardrails now prove published auction unit edits preserve location, media, highlights, governance, approval, public search/detail output, bid/reserve aggregates, auction dates, and inventory totals. Browser edit-published ownership remains pending. Evidence: `docs/dle/AUCTION_ENGINE_TECHNICAL_PROOF.md`. |
...
| Public page | Correct sale/rent/auction display | Partial | Sale public page now renders with development name, sale pricing, unit type, CTA, and publish-critical highlights. Rental and auction public detail labels plus post-edit public detail output are covered by focused tests, but rental/auction browser public-page proof remains pending. Evidence: `docs/dle/evidence/2026-06-03/qa-dle-public-highlights-visible.png`, `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`, and `docs/dle/AUCTION_ENGINE_TECHNICAL_PROOF.md`. |
| Search cards | Correct sale/rent/auction pricing and ordering | Partial | Sale public list output includes published development `4`, `for_sale`, public highlights, and sale unit configuration with `priceFrom: 1750000`. Rental and auction public search/configuration pricing are covered before and after edit-published API proof. Rental/auction browser proof remains pending. Evidence: `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md` and `docs/dle/AUCTION_ENGINE_TECHNICAL_PROOF.md`. |
| Lead capture | Lead context matches transaction type and unit interest | Partial | Browser submitted a sale unit lead and DB verified development id, unit id/name, sale transaction context, price label, price, and `funnel_stage: interest`. Rental lead context is covered by focused persistence tests. Browser rental and auction lead proof remain pending. Evidence: `docs/dle/evidence/2026-06-03/qa-dle-lead-context-submitted.png` and `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`. |
| Edit published development | No unrelated field wipes | Partial | Sale edit-published ownership is browser/API/DB-proven for location, media, governance, marketing highlights, and unit types. Rental and auction edit-published ownership are API/DB-proven across the same ownership boundaries. Rental/auction browser proof remains pending before calling the full DLE stable. Evidence: `docs/dle/evidence/2026-06-03/qa-dle-edit-published-field-ownership-summary.md`, `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`, and `docs/dle/AUCTION_ENGINE_TECHNICAL_PROOF.md`. |
