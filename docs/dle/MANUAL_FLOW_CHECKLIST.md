...
| Public page | Correct sale/rent/auction display | Partial | Sale public page now renders with development name, sale pricing, unit type, CTA, and publish-critical highlights. Rental public detail labels and post-edit rental public detail output are covered by focused tests, but browser public-page proof remains pending. Evidence: `docs/dle/evidence/2026-06-03/qa-dle-public-highlights-visible.png` and `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`. |
| Search cards | Correct sale/rent/auction pricing and ordering | Partial | Sale public list output includes published development `4`, `for_sale`, public highlights, and sale unit configuration with `priceFrom: 1750000`. Rental public search/configuration pricing is covered before and after rental edit-published API proof. Auction search-card proof and rental browser proof remain pending. Evidence: `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`. |
...
| Edit published development | No unrelated field wipes | Partial | Sale edit-published ownership is browser/API/DB-proven for location, media, governance, marketing highlights, and unit types. Rental edit-published ownership is API/DB-proven across the same ownership boundaries. Rental browser proof and auction proof remain pending before calling the full DLE stable. Evidence: `docs/dle/evidence/2026-06-03/qa-dle-edit-published-field-ownership-summary.md` and `docs/dle/RENTAL_ENGINE_TECHNICAL_PROOF.md`. |
