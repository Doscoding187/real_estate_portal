...
import { type ExploreIntent, readStoredExploreIntent, writeStoredExploreIntent } from '@/lib/exploreIntent';
...
export function useExploreIntent() {
  ...
  const [localIntent, setLocalIntent] = useState<ExploreIntent | null>(() => readStoredExploreIntent());
