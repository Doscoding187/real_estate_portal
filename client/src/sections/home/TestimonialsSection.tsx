...
export function TestimonialsSection() {
  return (
    <section className="home-section bg-gradient-to-b from-slate-50/50 to-white">
      <div className="home-section-header text-left">
        ...
        <h2 className="home-section-title text-[1.125rem] font-bold text-slate-900 sm:text-xl md:text-[26px]">
      ...
      <div className="relative">
        <div className="home-card-grid scrollbar-hide flex snap-x overflow-x-auto px-0.5 pb-4 md:grid md:grid-cols-3 md:overflow-visible md:px-0">
          {testimonials.map((testimonial, idx) => (
            <div
              key={idx}
              className="group relative flex min-h-[260px] w-[78vw] max-w-[292px] flex-none snap-start flex-col rounded-2xl border border-slate-200/70 bg-white p-3.5 shadow-[0_14px_36px_rgba(15,23,42,0.06)] transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl sm:w-[320px] sm:p-6 md:h-full md:min-h-[280px] md:w-auto md:max-w-none"
            >
              ...
              <div className="relative flex flex-1 flex-col">
                ...
                <p className="mb-4 flex-1 text-[13px] italic leading-5 text-slate-700 sm:mb-6 sm:text-base sm:leading-relaxed">
                  "{testimonial.text}"
                </p>
                <div className="mt-auto flex items-center gap-3 border-t border-slate-100 pt-4 sm:gap-4">
                  <div
