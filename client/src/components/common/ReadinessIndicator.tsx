            ...
            <Tooltip>
                <TooltipTrigger asChild>
                    <div className={cn("flex items-center gap-2", className)}>
                        ...
                        {isReady ? <CheckCircle2 className="w-4 h-4 text-green-500" /> : <AlertCircle className="w-4 h-4 text-amber-500" />}
                    </div>
                </TooltipTrigger>
            ...
            <TooltipTrigger>
                 <div className="relative" style={{ width: sizePx, height: sizePx }}>
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <span className={cn("font-bold", size === 'sm' ? 'text-[10px]' : 'text-xs', colorClass)}>
                            {score}%
                        </span>
                    </div>
                </div>
