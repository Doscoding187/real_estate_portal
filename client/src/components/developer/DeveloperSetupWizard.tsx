            ...
            {STEPS.map(s => {
              ...
              return (
                <div key={s.id} className="flex flex-col items-center bg-slate-50 px-2">
                  ...
                  <span
                    className={`mt-2 text-xs font-medium ${isActive ? 'text-primary' : 'text-slate-500'}`}
                  >
                    {s.title}
                  </span>
                </div>
                      ...
                      {[
                        {
                          value: 'residential',
                          label: 'Residential',
                          description: 'Houses, apartments, estates',
                        },
                        {
                          value: 'commercial',
                          label: 'Commercial',
                          description: 'Offices, retail, business parks',
                        },
                        {
                          value: 'mixed_use',
                          label: 'Mixed Use',
                        ...
                        },
                        {
                          value: 'industrial',
                          label: 'Industrial',
                          description: 'Warehouses, factories, logistics',
                        },
                      ].map(spec => (
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2 mt-6 pt-6 border-t border-slate-200">
                    ...
                    <p className="text-sm text-slate-500 mb-2">
                      Highlight your company's experience and achievements (e.g., years in business,
                  ...
                  <div className="grid gap-2 mt-6 pt-6 border-t border-slate-200">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <Label className="text-base font-semibold">Past Projects</Label>
                    </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-slate-900">
                          {formValues.specializations?.map(s => s.replace('_', ' ')).join(', ') ||
                            'None selected'}
                        </p>
                      </div>
                      <div>
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <div className="grid gap-1.5 leading-none">
                      ...
                      <p className="text-sm text-slate-500">
                        By submitting this application, you agree to our Developer Terms of Service
                        and Privacy Policy.
                      </p>
                    </div>
                  </div>
