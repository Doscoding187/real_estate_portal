    ...
    >
      ...
      >
        ...
        <div
          {...attributes}
          {...listeners}
          className="absolute top-2 left-2 bg-gradient-to-br from-blue-500 to-blue-600 text-white rounded p-1.5 shadow-lg cursor-grab active:cursor-grabbing touch-none"
        >
      ...
      {media.isPrimary && (
        <div className="absolute top-2 right-12 bg-blue-500 text-white text-xs px-2 py-1 rounded shadow-md pointer-events-none">
          Primary
        </div>
      )}
