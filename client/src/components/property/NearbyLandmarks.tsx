  ...
  return (
    <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
      <div className="p-6 pb-0">
        ...
        <div className="group relative mb-6 h-[180px] sm:h-[240px] overflow-hidden rounded-xl border border-slate-200">
          {hasValidCoordinates ? (
            <>
              <img
              ...
              <div className="pointer-events-auto absolute inset-0 flex items-center justify-center opacity-100 md:opacity-0 md:transition-opacity md:group-hover:opacity-100">
                <Button
                  onClick={handleOpenMap}
                  className="flex scale-100 md:scale-95 items-center gap-2 rounded-full bg-blue-600 px-6 py-2 text-white shadow-lg transition-all duration-200 md:group-hover:scale-100 hover:bg-blue-700"
                >
            ...
            {connectedPOIs.map((poi: any, index: number) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <span className="rounded-full bg-slate-100 px-2 py-1 text-[10px] font-medium capitalize text-slate-600">
