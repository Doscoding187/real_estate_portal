...
export function DevelopmentGallery({
  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-5 gap-fluid-md h-[400px] lg:h-[520px]">
      {/* LEFT: Featured Media (60% - 3 columns) */}
      <div className="lg:col-span-3 relative rounded-card overflow-hidden shadow-soft h-full group bg-slate-900 ring-1 ring-black/5">
        ...
        <button
          ...
          className="absolute bottom-4 right-4 bg-white/95 hover:bg-white backdrop-blur-md px-5 py-2.5 rounded-pill font-semibold text-sm shadow-soft border border-white/20 transition-all hover:scale-105 hover:shadow-lg flex items-center gap-2"
        >
      ...
      <div className="lg:col-span-2 grid grid-rows-2 gap-fluid-md h-full">
        {/* Top Row: 2 cards side by side (50/50) */}
        <div className="grid grid-cols-2 gap-fluid-md h-full">
          {/* Amenities Card */}
          <button
            onClick={() => onOpenLightbox(indices.amenities, 'Amenities')}
            className="relative rounded-card overflow-hidden shadow-soft hover:shadow-hover transition-all group h-full ring-1 ring-black/5"
          >
            <img
            ...
            <span className="absolute right-3 bottom-3 bg-white/95 backdrop-blur-md px-4 py-1.5 rounded-pill font-semibold text-xs shadow-sm border border-white/20">
              Amenities
            </span>
          </button>
                ...
                if (showVideoTile) {
                    return (
                        <button
                          ...
                          className="relative w-full h-full rounded-card overflow-hidden shadow-soft hover:shadow-hover transition-all group ring-1 ring-black/5"
                        >
                          <img
