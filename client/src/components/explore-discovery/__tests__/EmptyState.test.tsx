...
describe('EmptyState', () => {
  ...
  describe('Custom Props', () => {
    it('renders custom title', () => {
      render(<EmptyState type="noResults" customTitle="Custom Title" />);
    ...
    it('renders custom description', () => {
      render(<EmptyState type="noResults" customDescription="Custom description text" />);

      expect(screen.getByText('Custom description text')).toBeInTheDocument();
    });

    it('renders custom action label', () => {
      render(<EmptyState type="noResults" customActionLabel="Custom Action" onAction={() => {}} />);
  ...
  describe('Actions', () => {
    ...
    it('renders only primary action when no secondary handler', () => {
      render(<EmptyState type="noSavedProperties" onAction={() => {}} />);
  ...
  describe('Compact Mode', () => {
    it('applies compact styling when compact prop is true', () => {
      const { container } = render(<EmptyState type="noResults" compact />);
    ...
    it('applies regular styling when compact prop is false', () => {
      const { container } = render(<EmptyState type="noResults" compact={false} />);
  ...
  describe('Custom ClassName', () => {
    it('applies custom className', () => {
      const { container } = render(<EmptyState type="noResults" className="custom-class" />);
...
describe('EmptyStateCard', () => {
  it('renders EmptyState wrapped in ModernCard', () => {
    render(<EmptyStateCard type="noResults" onAction={() => {}} />);
  ...
  it('applies custom card className', () => {
    const { container } = render(
      <EmptyStateCard type="noResults" cardClassName="custom-card-class" />,
    );
  ...
  it('passes through EmptyState props', () => {
    ...
    render(<EmptyStateCard type="noResults" customTitle="Custom Title" onAction={handleAction} />);
...
describe('InlineEmptyState', () => {
  it('renders with default icon', () => {
    render(<InlineEmptyState message="No items found" />);

    expect(screen.getByText('No items found')).toBeInTheDocument();
  });

  it('renders with custom icon', () => {
    const { container } = render(<InlineEmptyState message="No items found" />);
  ...
  it('renders action button when provided', () => {
    ...
    render(
      <InlineEmptyState message="No items found" actionLabel="Add Item" onAction={handleAction} />,
    );
  ...
  it('applies custom className', () => {
    const { container } = render(
      <InlineEmptyState message="No items found" className="custom-inline-class" />,
    );
...
describe('useEmptyState Hook', () => {
  it('returns showEmpty false when loading', () => {
    const { result } = renderHook(() => useEmptyState(false, true, null));
  ...
  it('returns showEmpty false when error exists', () => {
    const { result } = renderHook(() => useEmptyState(false, false, new Error('Test error')));
  ...
  it('returns showEmpty true when no data and not loading', () => {
    const { result } = renderHook(() => useEmptyState(false, false, null));
  ...
  it('returns showEmpty false when has data', () => {
    const { result } = renderHook(() => useEmptyState(true, false, null));
