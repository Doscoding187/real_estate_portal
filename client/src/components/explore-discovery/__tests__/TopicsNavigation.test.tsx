...
const createWrapper = () => {
  ...
  Wrapper.displayName = 'TopicsNavigationTestWrapper';
  return Wrapper;
};
...
describe('TopicsNavigation', () => {
  ...
  it('renders loading skeleton while fetching topics', () => {
    ...
    render(<TopicsNavigation activeTopic={null} onTopicSelect={onTopicSelect} />, {
  ...
  it('highlights active topic correctly', async () => {
    ...
    render(<TopicsNavigation activeTopic="home-security" onTopicSelect={onTopicSelect} />, {
      wrapper: createWrapper(),
    });
