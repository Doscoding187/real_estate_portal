...
describe('Lighthouse Accessibility Properties', () => {
  ...
  it.prop([fc.integer({ min: 1, max: 10 })])(
    'should validate accessibility patterns exist',
    iterations => {
  ...
  it.prop([fc.constant('aria-labels')])(
  ...
  it.prop([fc.constant('skip-links')])(
  ...
  it.prop([fc.constant('heading-hierarchy')])(
  ...
  it.prop([fc.constant('keyboard-navigation')])(
  ...
  it.prop([fc.constant('focus-management')])(
  ...
  it.prop([fc.constant('color-contrast')])(
  ...
  it.prop([fc.constant('form-labels')])(
    ...
    labels => {
      ...
      const labelPatterns = ['label elements', 'for/id association', 'aria-label fallback'];
  ...
  it.prop([fc.constant('interactive-elements')])(
  ...
  it.prop([fc.constant('breadcrumb')])(
  ...
  it.prop([fc.constant('reduced-motion')])(
