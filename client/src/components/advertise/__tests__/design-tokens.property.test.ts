...
describe('Design Token Consistency - Property Tests', () => {
  ...
  it('should have valid color values for all color tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.colors)), colorCategory => {
  ...
  it('should have valid shadow values for all shadow tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.shadows)), shadowKey => {
  ...
  it('should have valid border radius values for all radius tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.borderRadius)), radiusKey => {
        const radiusValue =
          softUITokens.borderRadius[radiusKey as keyof typeof softUITokens.borderRadius];
  ...
  it('should have valid transition timing for all transition tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.transitions)), transitionKey => {
        const transitionValue =
          softUITokens.transitions[transitionKey as keyof typeof softUITokens.transitions];
  ...
  it('should have valid spacing values for all spacing tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.spacing)), spacingKey => {
  ...
  it('should have valid font size values for all typography tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.typography.fontSize)), sizeKey => {
        const sizeValue =
          softUITokens.typography.fontSize[
            sizeKey as keyof typeof softUITokens.typography.fontSize
          ];
  ...
  it('should have valid font weight values for all weight tokens', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...Object.keys(softUITokens.typography.fontWeight)),
        weightKey => {
          const weightValue =
            softUITokens.typography.fontWeight[
              weightKey as keyof typeof softUITokens.typography.fontWeight
            ];
  ...
  it('should have valid line height values for all line height tokens', () => {
    fc.assert(
      fc.property(
        fc.constantFrom(...Object.keys(softUITokens.typography.lineHeight)),
        lineHeightKey => {
          const lineHeightValue =
            softUITokens.typography.lineHeight[
              lineHeightKey as keyof typeof softUITokens.typography.lineHeight
            ];
  ...
  it('should have valid breakpoint values for all breakpoint tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.breakpoints)), breakpointKey => {
        const breakpointValue =
          softUITokens.breakpoints[breakpointKey as keyof typeof softUITokens.breakpoints];
  ...
  it('should have valid z-index values for all z-index tokens', () => {
    fc.assert(
      fc.property(fc.constantFrom(...Object.keys(softUITokens.zIndex)), zIndexKey => {
