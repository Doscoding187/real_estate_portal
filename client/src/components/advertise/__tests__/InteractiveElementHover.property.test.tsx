...
describe('Property 19: Interactive Element Hover', () => {
  ...
  it('Property 19.4: Hover animations should have appropriate duration', () => {
    fc.assert(
      fc.property(
        fc.constantFrom('buttonPress', 'softLift'),
        (variantName) => {
    ...
    fc.assert(
      fc.property(
        ...
        () => {
          ...
          if (buttonPress.tap && typeof buttonPress.tap === 'object' && 'transition' in buttonPress.tap) {
            const tapTransition = (buttonPress.tap as any).transition;
            
            if (buttonPress.hover && typeof buttonPress.hover === 'object' && 'transition' in buttonPress.hover) {
  ...
  it('Property 19.8: Multiple interactive elements should have independent hover states', () => {
    fc.assert(
      fc.property(
        ...
        (numElements) => {
          const testIds = Array.from({ length: numElements }, (_, i) => `button-${Date.now()}-${i}`);
