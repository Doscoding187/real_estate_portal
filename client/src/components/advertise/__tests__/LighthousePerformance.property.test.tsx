...
describe('Lighthouse Performance Properties', () => {
  ...
  it.prop([fc.integer({ min: 1, max: 10 })])('should validate performance optimization patterns exist', (iterations) => {
  ...
  it.prop([fc.constant('performance')])('should have code splitting strategy', (strategy) => {
  ...
  it.prop([fc.constant('semantic-html')])('should use semantic HTML structure', (pattern) => {
  ...
  it.prop([fc.constant('resource-hints')])('should have resource optimization', (optimization) => {
  ...
  it.prop([fc.constant('error-boundaries')])('should have error handling', (errorHandling) => {
  ...
  it.prop([fc.constant('skeleton-loaders')])('should have loading states', (loadingPattern) => {
  ...
  it.prop([fc.constant('suspense')])('should use Suspense for code splitting', (pattern) => {
  ...
  it.prop([fc.constant('critical-css')])('should prioritize above-the-fold content', (priority) => {
