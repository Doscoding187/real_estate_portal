                ...
                {dev.featuredProject ? (
                  <div className="mt-auto relative h-48 group cursor-pointer block">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                      <div className="text-[10px] font-bold uppercase tracking-wider text-white/90 mb-1">
                        Featured Development
                      </div>
                      <h4 className="font-semibold text-sm line-clamp-1 mb-0.5">
                        {dev.featuredProject.title}
                      </h4>
                      <div className="flex justify-between items-end mt-1">
                        <p className="text-xs text-white/80 truncate mr-2">
                          {dev.featuredProject.location}
                        </p>
