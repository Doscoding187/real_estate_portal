...
export function FeaturedPropertiesCarousel({ locationId, locationName, locationScope }: FeaturedPropertiesCarouselProps) {
                ...
                <div className="flex flex-col mb-8">
                    ...
                    <div className="mb-6">
                         <div className="flex items-center gap-2 mb-2 text-yellow-600">
                            ...
                            <span className="font-semibold uppercase tracking-wider text-sm">Top Selling Projects</span>
                        </div>
                        <h2 className="text-3xl font-bold text-slate-900">Top Selling Projects in {locationName}</h2>
                    ...
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        ...
                        <Link href={`/search?location=${locationName}&sort=popular`}>
                            <Button variant="ghost" className="group text-primary hover:text-primary-700 hover:bg-primary-50 pl-0 md:pl-4">
                ...
                <div className="relative">
                    <Carousel className="w-full" opts={{ align: "start", loop: true }}>
                        <CarouselContent className="-ml-4 pb-4">
                            {listings.slice(0, 10).map((item) => { // Limit 10 slots per tab spec
