...
const navigationMenuTriggerStyle = cva(
  'group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium hover:bg-blue-50 hover:text-blue-700 focus:bg-blue-50 focus:text-blue-700 disabled:pointer-events-none disabled:opacity-50 data-[state=open]:hover:bg-blue-50 data-[state=open]:text-blue-700 data-[state=open]:focus:bg-blue-50 data-[state=open]:bg-blue-50 focus-visible:ring-blue-500/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1',
);
