...
export const PublishSuccess: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-8 text-center h-full min-h-[500px]">
      ...
      <h2 className="text-3xl font-bold text-gray-900 mb-4">Development Submitted Successfully!</h2>

      <p className="text-lg text-gray-600 max-w-md mb-8">
        Your development has been submitted for review. It will be reviewed by our team within 24
        hours. You can check the status in your dashboard.
      </p>
