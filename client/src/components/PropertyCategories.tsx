  ...
  const categories = [
    {
      Icon: Building2,
      title: 'Apartments',
      count: filterCounts?.byPropertyType?.apartment || 0,
      type: 'apartment',
      gradient: 'from-[#2774AE] to-[#2D68C4]',
    },
    {
      Icon: HomeIcon,
      title: 'Houses',
      count: filterCounts?.byPropertyType?.house || 0,
      type: 'house',
      gradient: 'from-[#2D68C4] to-[#0F52BA]',
    },
    {
      Icon: Building,
      title: 'Townhouses',
      count: filterCounts?.byPropertyType?.townhouse || 0,
      type: 'townhouse',
    ...
    },
    {
      Icon: Tractor,
      title: 'Farms',
      count: filterCounts?.byPropertyType?.farm || 0,
      type: 'farm',
      gradient: 'from-[#2D68C4] to-[#0F52BA]',
    },
  ];
        ...
        <div className="flex overflow-x-auto gap-4 pb-2 snap-x scrollbar-hide -mx-4 px-4 sm:grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 sm:gap-4 md:gap-6 sm:overflow-visible sm:mx-0 sm:px-0">
          {categories.map((category, idx) => (
            ...
            >
              ...
              <div
                className={`relative mb-4 p-4 md:p-5 rounded-2xl bg-gradient-to-br ${category.gradient} shadow-lg group-hover:shadow-2xl group-hover:scale-110 transition-all duration-500`}
              >
              ...
              <DialogTitle className="text-center">
                {step === 1 ? (
                  ...
                  <span className="flex flex-col gap-2">
                    ...
                    <span className="text-sm font-normal text-muted-foreground">
                      Looking for {selectedCategory?.title} in{' '}
                      <span className="text-[#2774AE] font-medium">{selectedLocation?.name}</span>
                    </span>
                  </span>
                )}
              </DialogTitle>
              ...
              {step === 1 ? (
                ...
                <div className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full h-12 text-base font-semibold bg-[#2774AE] hover:bg-[#206498] mt-4"
                  >
                    View Properties
                  </Button>
