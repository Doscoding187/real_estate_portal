            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm text-slate-500 mt-1">
                <Badge variant="outline" className="capitalize">
                  {developer.category.replace('_', ' ')}
                </Badge>
                <span className="flex items-center gap-1">
                  <MapPin className="w-3 h-3" /> {developer.city}, {developer.province}
                </span>
                <span className="flex items-center gap-1">
              ...
              <div className="mt-4 grid grid-cols-2 gap-x-8 gap-y-2 text-sm">
                <div>
                  <span className="text-slate-500">Email:</span> {developer.email}
                </div>
                <div>
                  <span className="text-slate-500">Phone:</span> {developer.phone || 'N/A'}
                </div>
                <div>
                  <span className="text-slate-500">Website:</span> {developer.website || 'N/A'}
                </div>
                <div>
                  <span className="text-slate-500">Projects:</span> {developer.totalProjects}
                </div>
              </div>
            </div>
          </div>
      ...
      <Dialog open={isRejectDialogOpen} onOpenChange={setIsRejectDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Please provide a reason for rejecting {selectedDeveloper?.name}'s application. This
