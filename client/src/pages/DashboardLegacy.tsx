...
/**
 * @deprecated
 * Do not use. Replaced by role-specific dashboards.
 */
export default function Dashboard() {
  console.warn(
    '⚠️ Legacy Dashboard mounted — this should not happen. Users should be redirected to role-specific dashboards.',
  );
