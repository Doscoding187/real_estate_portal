...
export default function LandDetail() {
  ...
  return <main className="mx-auto max-w-4xl space-y-6 p-6">
    ...
    <section className="rounded border p-4">
      ...
      <button className="m-1 rounded bg-slate-900 px-3 py-2 text-white" onClick={() => enquiry.mutate({ name, email, message, listingId: land.listingId, leadType: 'inquiry', source: 'plots_and_land', sourceSurface: 'land_detail' })}>Request information</button>
    </section>
  </main>;
}
