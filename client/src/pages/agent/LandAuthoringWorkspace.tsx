...
const labels: Record<string, string> = { residential_stand: 'Residential stand', development_land: 'Development land', commercial_industrial_land: 'Commercial / industrial land' };

export default function LandAuthoringWorkspace() {
  const [, setLocation] = useLocation();
  const [listingId, setListingId] = useState<number | null>(null);
  const [form, setForm] = useState({ classification: 'residential_stand' as keyof typeof labels, title: '', description: '', askingPrice: '', city: '', province: '', parcelKind: 'erf' as 'erf' | 'portion' | 'farm' | 'remainder' | 'other', parcelReference: '', extentM2: '', intendedUse: '' });
  ...
  return <AgentAppShell activeNav="listings"><main className="mx-auto max-w-5xl space-y-6 p-4 md:p-8">
