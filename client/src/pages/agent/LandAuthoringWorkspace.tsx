...
export default function LandAuthoringWorkspace() {
  ...
  const [form, setForm] = useState({ classification: 'residential_stand' as LandClassification, title: '', description: '', askingPrice: '', city: '', province: '', parcelKind: 'erf' as 'erf' | 'portion' | 'farm' | 'remainder' | 'other', parcelReference: '', extentM2: '', intendedUse: '' });
