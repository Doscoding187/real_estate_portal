    ...
    <div className="min-h-screen bg-white">
      <div className="py-12 px-4 bg-gradient-to-r from-primary to-purple-600">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">FAQ Section Demo</h1>
      ...
      <div className="py-12 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          ...
          <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Keyboard Navigation</h3>
          <ul className="space-y-2 text-gray-600">
            <li>
              <kbd className="px-2 py-1 bg-gray-200 rounded">Tab</kbd> - Navigate between FAQ items
            </li>
            <li>
              <kbd className="px-2 py-1 bg-gray-200 rounded">Enter</kbd> or{' '}
              <kbd className="px-2 py-1 bg-gray-200 rounded">Space</kbd> - Toggle accordion
            </li>
            <li>
              <kbd className="px-2 py-1 bg-gray-200 rounded">Shift + Tab</kbd> - Navigate backwards
            </li>
          </ul>

          <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">Accessibility Features</h3>
          <ul className="space-y-2 text-gray-600">
