...
export default function DevelopmentDetail() {
  ...
  const development = {
    ...
    description: 'Experience luxury living at its finest with Sandton Heights, an exclusive development featuring world-class amenities, premium finishes, and breathtaking views. Located in the heart of Sandton\'s business district, this development offers unparalleled convenience and sophistication.',
    ...
    // Categorized media
    allPhotos: [
      { url: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?w=1200', type: 'image' as const },
    ],
    amenitiesPhotos: [
      { url: 'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=1200', type: 'image' as const },
    ],
    outdoorsPhotos: [
      { url: 'https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=1200', type: 'image' as const },
      { url: 'https://images.unsplash.com/photo-1600607687644-c7171b42498b?w=1200', type: 'image' as const },
    ],
    videos: [
      // Mock video - replace with actual development video URLs
      { url: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200', type: 'image' as const }, // Placeholder
    ],
  };
        ...
        <div className="max-w-7xl mx-auto px-4 pt-24 pb-6">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-5 gap-3 mb-8">
            ...
            <div className="lg:col-span-3 relative rounded-xl overflow-hidden shadow-md h-[480px] group bg-slate-900">
              ...
              <button
                onClick={() => openLightbox(development.featuredMedia.type === 'video' ? 'videos' : 'all', development.featuredMedia.type === 'video' ? 'Watch Video' : 'All Photos')}
              ...
              >
                {development.featuredMedia.type === 'video' ? 'Watch video' : `View all ${development.totalPhotos} photos`}
              </button>
            </div>
            ...
            <div className="lg:col-span-2 grid grid-rows-2 gap-3 h-[480px]">
              ...
              <button
                onClick={() => openLightbox(development.featuredMedia.type === 'video' ? 'all' : 'videos', development.featuredMedia.type === 'video' ? 'All Photos' : 'Videos')}
                className="relative rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all group"
              >
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent" />
                <span className="absolute right-2 bottom-2 bg-white/96 backdrop-blur-sm px-2.5 py-1.5 rounded-full font-semibold text-xs shadow-md border border-slate-200/50">
                  {development.featuredMedia.type === 'video' ? `Photos (${development.totalPhotos})` : 'Videos'}
                </span>
              </button>
            </div>
          </section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <Card>
            <CardContent className="p-4 text-center">
              ...
              <p className="text-xl font-bold text-blue-600">R {(development.startingPrice / 1000000).toFixed(1)}M</p>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {development.units.map((unit) => (
                    ...
                    >
                      <img src={unit.image} alt={unit.type} className="w-full h-48 object-cover" />
                      <div className="p-4">
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <Card>
                ...
                <CardContent className="p-4 space-y-3">
                  ...
                  <Button variant="outline" className="w-full py-6 border-2 border-blue-600 text-blue-600 hover:bg-blue-50">
              ...
              <Card>
                ...
                <CardContent className="p-4">
                  <p className="font-semibold mb-2">{development.developer}</p>
