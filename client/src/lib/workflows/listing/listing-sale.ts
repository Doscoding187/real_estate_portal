/**
 * Listing Workflow — Sell
 *
 * Defines the step flow for a single-property sale listing.
 * Steps are composed dynamically; some steps are conditional on
 * property type (e.g. farm-specific fields).
 */
