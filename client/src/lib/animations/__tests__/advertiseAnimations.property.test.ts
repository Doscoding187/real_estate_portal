...
describe('Animation Timing - Property Tests', () => {
  ...
  it('should have valid duration constants in animationConfig', () => {
    fc.assert(
      fc.property(
        ...
        (durationKey) => {
          const duration = animationConfig.duration[durationKey as keyof typeof animationConfig.duration];
  ...
  it('should have valid easing functions in animationConfig', () => {
    fc.assert(
      fc.property(
        fc.constantFrom('default', 'spring', 'easeOut', 'easeIn'),
        (easingKey) => {
