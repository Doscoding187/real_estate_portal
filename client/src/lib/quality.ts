...
export function calculateListingQualityScore(listing: any): ListingQualityBreakdown {
  ...
  const hasFloorSize = !!(listing.floorSize || listing.propertySize || listing.erfSize || (listing.propertyDetails && (listing.propertyDetails.unitSizeM2 || listing.propertyDetails.erfSizeM2)));
