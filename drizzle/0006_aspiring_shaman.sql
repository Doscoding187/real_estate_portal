...
ALTER TABLE `development_drafts` ADD CONSTRAINT `development_drafts_developer_brand_profile_id_developer_6228e723` FOREIGN KEY (`developer_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `developments` ADD CONSTRAINT `developments_marketing_brand_profile_id_developer_brand_36a33e65` FOREIGN KEY (`marketing_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
