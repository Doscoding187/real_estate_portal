...
ALTER TABLE `properties` ADD CONSTRAINT `properties_developer_brand_profile_id_developer_brand_p_f25d576a` FOREIGN KEY (`developer_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
