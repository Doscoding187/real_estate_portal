...
export const developerBrandProfilesRelations = relations(
  developerBrandProfiles,
  ({ one, many }) => ({
    developer: one(developers, {
...
export const developerSubscriptionLimitsRelations = relations(
  developerSubscriptionLimits,
  ({ one }) => ({
...
export const developerSubscriptionsRelations = relations(
  developerSubscriptions,
  ({ one, many }) => ({
...
export const developerSubscriptionUsageRelations = relations(
  developerSubscriptionUsage,
  ({ one }) => ({
    developerSubscription: one(developerSubscriptions, {
