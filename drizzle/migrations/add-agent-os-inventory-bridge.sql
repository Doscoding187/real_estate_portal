...
-- Best-effort backfill for published inventory created from listings before sourceListingId existed.
UPDATE properties p
JOIN (
...
-- Backfill showing.propertyId where a source listing bridge now exists.
UPDATE showings s
JOIN properties p
