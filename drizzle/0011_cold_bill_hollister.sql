...
ALTER TABLE `development_lead_routes` ADD CONSTRAINT `development_lead_routes_source_brand_profile_id_develop_aa33febd` FOREIGN KEY (`source_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `development_lead_routes` ADD CONSTRAINT `development_lead_routes_receiver_brand_profile_id_devel_859e18f2` FOREIGN KEY (`receiver_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE `development_lead_routes` ADD CONSTRAINT `development_lead_routes_fallback_brand_profile_id_devel_ba5c339a` FOREIGN KEY (`fallback_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE `development_partners` ADD CONSTRAINT `development_partners_brand_profile_id_developer_brand_p_fb7e6803` FOREIGN KEY (`brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
