...
export const developments = mysqlTable("developments", {
	...
	marketingBrandProfileId: int("marketing_brand_profile_id"), // NEW: Marketing Agency
...
(table) => [
	foreignKey({
		...
		name: "fk_dev_brand_prof"
	}).onDelete("set null"),
	foreignKey({
		columns: [table.marketingBrandProfileId],
		foreignColumns: [developerBrandProfiles.id],
		name: "fk_dev_mkt_prof"
	}).onDelete("set null"),
...
(table) => [
	foreignKey({
		...
		foreignColumns: [developerBrandProfiles.id],
		name: "fk_dev_partner_branded_prof"
	}).onDelete("cascade"),
...
(table) => [
	foreignKey({
		...
		foreignColumns: [developerBrandProfiles.id],
		name: "fk_lead_routes_source"
	}).onDelete("cascade"),
	foreignKey({
		columns: [table.receiverBrandProfileId],
		foreignColumns: [developerBrandProfiles.id],
		name: "fk_lead_routes_recv"
	}).onDelete("cascade"),
	foreignKey({
		columns: [table.fallbackBrandProfileId],
		foreignColumns: [developerBrandProfiles.id],
		name: "fk_lead_routes_fall"
	}).onDelete("set null"),
