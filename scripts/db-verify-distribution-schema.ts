...
const REQUIRED_COLUMNS: Array<{ table: string; column: string }> = [
  ...
  { table: 'development_required_documents', column: 'transaction_type' },
  { table: 'development_required_documents', column: 'participant_type' },
  { table: 'development_required_documents', column: 'readiness_role' },
  { table: 'development_required_documents', column: 'required_for_stage' },
  { table: 'development_required_documents', column: 'blocks_payout' },
  { table: 'development_required_documents', column: 'review_owner' },
  { table: 'development_required_documents', column: 'publicly_shareable' },
  { table: 'development_required_documents', column: 'programme_specific' },
