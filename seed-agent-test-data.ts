...
async function seedAgentTestData() {
  ...
  try {
    ...
    const testProperties = [
      {
        ...
        description:
          'Stunning 3-bedroom penthouse with panoramic city views, private pool, and premium finishes.',
      ...
      },
      {
        ...
        description:
          'Beautiful 4-bedroom house with garden, pool, and double garage in secure estate.',
        propertyType: 'house',
        listingType: 'sale',
        transactionType: 'sale',
        price: 5200000,
      ...
      },
      {
        ...
        description:
          'Contemporary 2-bedroom apartment in prime location, perfect for young professionals.',
        propertyType: 'apartment',
        listingType: 'rent',
    ...
    for (const commission of testCommissions) {
      ...
      console.log(
        `   ✓ ${commission.transactionType} - R${(commission.amount / 100).toLocaleString()} (${commission.status})`,
      );
    }
