...
describe('Explore Discovery Engine Database Schema', () => {
  ...
  describe('Table Creation and Constraints', () => {
    ...
    it.skipIf(skipTests)('should have explore_discovery_videos table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_neighbourhoods table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_user_preferences_new table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_feed_sessions table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_engagements table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_boost_campaigns table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_saved_properties table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_neighbourhood_follows table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_creator_follows table with correct structure', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have explore_categories table with correct structure', async () => {
      if (!db) return;
  ...
  describe('Spatial Index Functionality', () => {
    ...
    it.skipIf(skipTests)('should have location indexes on explore_neighbourhoods table', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should support location-based queries on explore_neighbourhoods', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should efficiently query content by location with engagement score', async () => {
      if (!db) return;
      ...
      for (let i = 0; i < results.rows.length - 1; i++) {
        expect(Number(results.rows[i].engagement_score))
          .toBeGreaterThanOrEqual(Number(results.rows[i + 1].engagement_score));
      }
      
      // Cleanup
      await db.execute(sql`DELETE FROM explore_content WHERE title LIKE 'TEST: Engagement Test%'`);
    });
  });
  ...
  describe('Foreign Key Relationships', () => {
    ...
    it.skipIf(skipTests)('should enforce foreign key from explore_discovery_videos to explore_content', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should cascade delete from explore_content to explore_discovery_videos', async () => {
      if (!db) return;
      // Insert test content
    ...
    it.skipIf(skipTests)('should enforce foreign key from explore_engagements to explore_content', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should enforce foreign key from explore_boost_campaigns to users and explore_content', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should enforce unique constraint on explore_neighbourhoods slug', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should enforce unique constraint on explore_user_preferences_new user_id', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should enforce unique constraint on explore_saved_properties (user_id, content_id)', async () => {
      if (!db) return;
  ...
  describe('Index Verification', () => {
    ...
    it.skipIf(skipTests)('should have correct indexes on explore_discovery_videos table', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have correct indexes on explore_neighbourhoods table', async () => {
      if (!db) return;
      const indexes = await db.execute(sql`SHOW INDEX FROM explore_neighbourhoods`);
      const indexNames = indexes.rows.map((row: any) => row.Key_name);
    ...
    it.skipIf(skipTests)('should have correct indexes on explore_user_preferences_new table', async () => {
      if (!db) return;
    ...
    it.skipIf(skipTests)('should have correct indexes on explore_boost_campaigns table', async () => {
      if (!db) return;
  ...
  describe('Data Integrity', () => {
    it.skipIf(skipTests)('should properly store and retrieve JSON data in explore_content', async () => {
      if (!db) return;
      ...
      const parsedMetadata = typeof row.metadata === 'string' 
        ...
        : row.metadata;
      const parsedTags = typeof row.tags === 'string' 
        ? JSON.parse(row.tags) 
        : row.tags;
      const parsedCategories = typeof row.lifestyle_categories === 'string' 
