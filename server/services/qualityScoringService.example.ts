...
async function example1_InitialContentCreation() {
  ...
  const initialScore = await qualityScoringService.calculateInitialScore(
    contentId,
    {
      ...
      description: 'Experience unparalleled luxury in this stunning 4-bedroom villa nestled in the heart of Constantia. Features include a gourmet kitchen, infinity pool, and breathtaking mountain views.',
