...
ALTER TABLE `properties` ADD CONSTRAINT `properties_developer_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`developer_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `developer_brand_profiles` ADD CONSTRAINT `developer_brand_profiles_linked_developer_account_id_developers_id_fk` FOREIGN KEY (`linked_developer_account_id`) REFERENCES `developers`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `developer_subscription_limits` ADD CONSTRAINT `developer_subscription_limits_subscription_id_developer_subscriptions_id_fk` FOREIGN KEY (`subscription_id`) REFERENCES `developer_subscriptions`(`id`) ON DELETE no action ON UPDATE no action;
ALTER TABLE `developer_subscription_usage` ADD CONSTRAINT `developer_subscription_usage_subscription_id_developer_subscriptions_id_fk` FOREIGN KEY (`subscription_id`) REFERENCES `developer_subscriptions`(`id`) ON DELETE no action ON UPDATE no action;
...
ALTER TABLE `development_drafts` ADD CONSTRAINT `development_drafts_developer_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`developer_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `development_lead_routes` ADD CONSTRAINT `development_lead_routes_source_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`source_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `development_lead_routes` ADD CONSTRAINT `development_lead_routes_receiver_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`receiver_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `development_lead_routes` ADD CONSTRAINT `development_lead_routes_fallback_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`fallback_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `developments` ADD CONSTRAINT `developments_developer_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`developer_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;
ALTER TABLE `developments` ADD CONSTRAINT `developments_marketing_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`marketing_brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `affordability_match_snapshots` ADD CONSTRAINT `affordability_match_snapshots_assessment_id_affordability_assessments_id_fk` FOREIGN KEY (`assessment_id`) REFERENCES `affordability_assessments`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `application_requirements` ADD CONSTRAINT `application_requirements_linked_development_document_id_development_documents_id_fk` FOREIGN KEY (`linked_development_document_id`) REFERENCES `development_documents`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `deal_requirement_statuses` ADD CONSTRAINT `deal_requirement_statuses_requirement_id_application_requirements_id_fk` FOREIGN KEY (`requirement_id`) REFERENCES `application_requirements`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `deal_requirement_statuses` ADD CONSTRAINT `deal_requirement_statuses_linked_development_document_id_development_documents_id_fk` FOREIGN KEY (`linked_development_document_id`) REFERENCES `development_documents`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `development_manager_assignments` ADD CONSTRAINT `development_manager_assignments_development_id_developments_id_fk` FOREIGN KEY (`development_id`) REFERENCES `developments`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_brand_partnerships` ADD CONSTRAINT `distribution_brand_partnerships_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_commission_entries` ADD CONSTRAINT `distribution_commission_entries_program_id_distribution_programs_id_fk` FOREIGN KEY (`program_id`) REFERENCES `distribution_programs`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `distribution_commission_entries` ADD CONSTRAINT `distribution_commission_entries_development_id_developments_id_fk` FOREIGN KEY (`development_id`) REFERENCES `developments`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_commission_ledger` ADD CONSTRAINT `distribution_commission_ledger_distribution_deal_id_distribution_deals_id_fk` FOREIGN KEY (`distribution_deal_id`) REFERENCES `distribution_deals`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_commission_overrides` ADD CONSTRAINT `distribution_commission_overrides_deal_id_distribution_deals_id_fk` FOREIGN KEY (`deal_id`) REFERENCES `distribution_deals`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_deal_documents` ADD CONSTRAINT `distribution_deal_documents_development_required_document_id_development_required_documents_id_fk` FOREIGN KEY (`development_required_document_id`) REFERENCES `development_required_documents`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_deals` ADD CONSTRAINT `distribution_deals_affordability_assessment_id_affordability_assessments_id_fk` FOREIGN KEY (`affordability_assessment_id`) REFERENCES `affordability_assessments`(`id`) ON DELETE set null ON UPDATE no action;
ALTER TABLE `distribution_deals` ADD CONSTRAINT `distribution_deals_affordability_match_snapshot_id_affordability_match_snapshots_id_fk` FOREIGN KEY (`affordability_match_snapshot_id`) REFERENCES `affordability_match_snapshots`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `distribution_development_access` ADD CONSTRAINT `distribution_development_access_development_id_developments_id_fk` FOREIGN KEY (`development_id`) REFERENCES `developments`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `distribution_development_access` ADD CONSTRAINT `distribution_development_access_brand_partnership_id_distribution_brand_partnerships_id_fk` FOREIGN KEY (`brand_partnership_id`) REFERENCES `distribution_brand_partnerships`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `distribution_development_access` ADD CONSTRAINT `distribution_development_access_brand_profile_id_developer_brand_profiles_id_fk` FOREIGN KEY (`brand_profile_id`) REFERENCES `developer_brand_profiles`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_program_workflow_steps` ADD CONSTRAINT `distribution_program_workflow_steps_workflow_id_distribution_program_workflows_id_fk` FOREIGN KEY (`workflow_id`) REFERENCES `distribution_program_workflows`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `distribution_program_workflows` ADD CONSTRAINT `distribution_program_workflows_program_id_distribution_programs_id_fk` FOREIGN KEY (`program_id`) REFERENCES `distribution_programs`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `distribution_viewing_validations` ADD CONSTRAINT `distribution_viewing_validations_deal_id_distribution_deals_id_fk` FOREIGN KEY (`deal_id`) REFERENCES `distribution_deals`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `distribution_viewing_validations` ADD CONSTRAINT `distribution_viewing_validations_development_id_developments_id_fk` FOREIGN KEY (`development_id`) REFERENCES `developments`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `qualification_pack_exports` ADD CONSTRAINT `qualification_pack_exports_assessment_id_affordability_assessments_id_fk` FOREIGN KEY (`assessment_id`) REFERENCES `affordability_assessments`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `qualification_pack_exports` ADD CONSTRAINT `qualification_pack_exports_match_snapshot_id_affordability_match_snapshots_id_fk` FOREIGN KEY (`match_snapshot_id`) REFERENCES `affordability_match_snapshots`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `saved_search_delivery_history` ADD CONSTRAINT `saved_search_delivery_history_saved_search_id_saved_searches_id_fk` FOREIGN KEY (`saved_search_id`) REFERENCES `saved_searches`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `agency_commission_settlement_payments` ADD CONSTRAINT `agency_commission_settlement_payments_settlement_id_agency_commission_settlements_id_fk` FOREIGN KEY (`settlement_id`) REFERENCES `agency_commission_settlements`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `agency_commission_settlement_payments` ADD CONSTRAINT `agency_commission_settlement_payments_recorded_by_user_id_users_id_fk` FOREIGN KEY (`recorded_by_user_id`) REFERENCES `users`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `agency_commission_settlements` ADD CONSTRAINT `agency_commission_settlements_transaction_id_agency_transactions_id_fk` FOREIGN KEY (`transaction_id`) REFERENCES `agency_transactions`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_transaction_activity` ADD CONSTRAINT `agency_transaction_activity_transaction_id_agency_transactions_id_fk` FOREIGN KEY (`transaction_id`) REFERENCES `agency_transactions`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_transaction_conditions` ADD CONSTRAINT `agency_transaction_conditions_transaction_id_agency_transactions_id_fk` FOREIGN KEY (`transaction_id`) REFERENCES `agency_transactions`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_transaction_documents` ADD CONSTRAINT `agency_transaction_documents_transaction_id_agency_transactions_id_fk` FOREIGN KEY (`transaction_id`) REFERENCES `agency_transactions`(`id`) ON DELETE cascade ON UPDATE no action;
ALTER TABLE `agency_transaction_documents` ADD CONSTRAINT `agency_transaction_documents_condition_id_agency_transaction_conditions_id_fk` FOREIGN KEY (`condition_id`) REFERENCES `agency_transaction_conditions`(`id`) ON DELETE set null ON UPDATE no action;
...
ALTER TABLE `agency_transaction_milestones` ADD CONSTRAINT `agency_transaction_milestones_transaction_id_agency_transactions_id_fk` FOREIGN KEY (`transaction_id`) REFERENCES `agency_transactions`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_transaction_parties` ADD CONSTRAINT `agency_transaction_parties_transaction_id_agency_transactions_id_fk` FOREIGN KEY (`transaction_id`) REFERENCES `agency_transactions`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_transactions` ADD CONSTRAINT `agency_transactions_accepted_offer_version_id_agency_deal_offer_versions_id_fk` FOREIGN KEY (`accepted_offer_version_id`) REFERENCES `agency_deal_offer_versions`(`id`) ON DELETE restrict ON UPDATE no action;
...
ALTER TABLE `seller_mandate_comparables` ADD CONSTRAINT `seller_mandate_comparables_mandate_operation_id_seller_mandate_operations_id_fk` FOREIGN KEY (`mandate_operation_id`) REFERENCES `seller_mandate_operations`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `seller_mandate_operations` ADD CONSTRAINT `seller_mandate_operations_seller_prospect_id_seller_prospects_id_fk` FOREIGN KEY (`seller_prospect_id`) REFERENCES `seller_prospects`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `seller_prospect_activities` ADD CONSTRAINT `seller_prospect_activities_seller_prospect_id_seller_prospects_id_fk` FOREIGN KEY (`seller_prospect_id`) REFERENCES `seller_prospects`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_listing_performance_activity` ADD CONSTRAINT `agency_listing_performance_activity_review_id_agency_listing_performance_reviews_id_fk` FOREIGN KEY (`review_id`) REFERENCES `agency_listing_performance_reviews`(`id`) ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE `agency_listing_performance_reviews` ADD CONSTRAINT `agency_listing_performance_reviews_responsible_agent_id_agents_id_fk` FOREIGN KEY (`responsible_agent_id`) REFERENCES `agents`(`id`) ON DELETE set null ON UPDATE no action;
ALTER TABLE `agency_listing_performance_reviews` ADD CONSTRAINT `agency_listing_performance_reviews_created_by_user_id_users_id_fk` FOREIGN KEY (`created_by_user_id`) REFERENCES `users`(`id`) ON DELETE set null ON UPDATE no action;
ALTER TABLE `agency_listing_performance_reviews` ADD CONSTRAINT `agency_listing_performance_reviews_canonical_revision_listing_id_listings_id_fk` FOREIGN KEY (`canonical_revision_listing_id`) REFERENCES `listings`(`id`) ON DELETE set null ON UPDATE no action;
