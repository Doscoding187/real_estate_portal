-- Create prospect-related tables for the gamified pre-qualification dashboard
-- This migration creates 4 new tables to support the Phase 4 prospect management system
...
-- You can now run this migration with:
