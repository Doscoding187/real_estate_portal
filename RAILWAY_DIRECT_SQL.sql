-- Run this SQL directly in Railway's MySQL database console
-- Go to Railway Dashboard → MySQL Database → Query tab → Paste and Run

-- 1. Create explore_shorts table
...
-- 2. Create explore_interactions table
...
-- 3. Create explore_highlight_tags table
...
-- 4. Create explore_user_preferences table
